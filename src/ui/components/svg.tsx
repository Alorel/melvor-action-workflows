...
export const ChevronDownSvg = staticComponent<ChevronProps>(function ChevronDown(props) {
  return <ChevronBase chevRotate={90} {...props}/>;
});

export const ChevronLeftSvg = staticComponent<ChevronProps>(function ChevronLeft(props) {
  return <ChevronBase chevRotate={180} {...props}/>;
});

export const ChevronUpSvg = staticComponent<ChevronProps>(function ChevronUp(props) {
  return <ChevronBase chevRotate={270} {...props}/>;
});

type NoSpaceProps = Omit<SvgProps, 'xmlSpace'>;
export const BinSvg = staticComponent<NoSpaceProps>(function Bin(props) {
  return (
...
export const TargetSvg = staticComponent<NoSpaceProps>(function Target(props) {
  return (
    <BaseSvg xmlSpace={'preserve'} viewBox={'0 0 512 512'} {...props}>
      <path fill={'#bfe4f8'}
...
export const PlaySvg = staticComponent<NoSpaceProps>(function Play(props) {
  return (
...
export const PauseSvg = staticComponent<NoSpaceProps>(function Pause(props) {
  return (
