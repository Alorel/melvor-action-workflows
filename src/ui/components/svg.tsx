...
const ChevronBase: FunctionComponent<ChevronBaseProps> = ({chevRotate, style, ...rest}) => (
  <BaseSvg
    ...
    {...rest}>
    <path d={'M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z'} opacity={'.1'}/>
...
export const BinSvg = staticComponent<NoSpaceProps>(props => (
  <BaseSvg xmlSpace={'preserve'} viewBox={'0 0 512 512'} {...props}>
    ...
    <path opacity={'.1'} d={'M211.582,72.19h-45.054c-31.038,0-56.198,25.16-56.198,56.198v22.857\th45.054v-22.857C155.384,97.35,180.544,72.19,211.582,72.19z'}/>
    <path fill={'#7eb35b'} d={'M97.295,160.597l28.644,313.576c1.958,21.425,19.924,37.826,41.438,37.826h177.244\tc21.514,0,39.482-16.401,41.438-37.826l28.644-313.576H97.295z'}/>
